import { BRAND, BUSINESS, SHIPPING, formatINR } from "./config";
...
const free = formatINR(SHIPPING.freeAbovePaise);
const flat = formatINR(SHIPPING.flatRatePaise);
const window = BUSINESS.returnWindowDays;
    ...
    sections: [
      {
        ...
        body: [
          `${BRAND.legalName} ships to addresses across India. We do not ship internationally at this time.`,
        ],
      },
      {
        heading: "Charges",
      ...
      },
      {
        ...
        body: [
          `Pieces marked "Ready to Ship" are dispatched within ${BUSINESS.dispatchDays} working days of payment confirmation.`,
      ...
      },
      {
        ...
        body: [
          ...
          `If your order has not arrived within 10 working days of dispatch, write to ${BRAND.email} and we will trace it for you.`,
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          `To raise a return, write to ${BRAND.email} with your order number and photographs of the piece.`,
        ],
      },
      {
      ...
      },
      {
        heading: "Refunds",
        body: [
          `Approved refunds are issued to the original payment method within ${BUSINESS.refundDays} working days of us receiving and inspecting the returned piece.`,
...

  {
    ...
    sections: [
      ...
      },
      {
        heading: "Your rights",
        body: [
          `You may ask us at any time to show you the data we hold about you, correct it, or delete it. Write to ${BRAND.email} and we will act within 30 days.`,
    ...
    sections: [
      {
        ...
        body: [
          `This website is operated by ${BUSINESS.legalEntity}. By placing an order you agree to these terms.`,
      ...
      },
      {
        ...
        body: [
          `All photographs, text, designs and the ${BRAND.legalName} name and logo on this website belong to us and may not be reproduced without written permission.`,
        ],
      },
      {
